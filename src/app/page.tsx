  ...
  return (
    <div className="relative h-screen w-full">
      <nav className="z-50 absolute top-0 left-0 w-full flex justify-between p-7">
        <div className="Nephilm-400 text-2xl z-10">Quizzie</div>
        <div className="poppins-medium  font-bold gradient-border-button">Create Now</div>
      </nav>
...
>
  <span className="text-sm">Try Quizzie Out!</span>
  <div
  ...
  >
    <div className="relative h-full w-10 bg-white/20"></div>
          ...
          <div className="poppins-medium  font-bold gradient-border-button w-fit text-sm ">Create Now</div>
          </div>
        </div>
